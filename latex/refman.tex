...
\vspace*{1cm}
{\large Generato da Doxygen 1.8.20}\\
\end{center}
\end{titlepage}
...
\input{structcliente}
\input{structordine}
\input{structprodotto}
\chapter{Documentazione dei file}
\input{_appello1_settembre_8c}
\input{_appello1_settembre_8h}
\input{_gestione__clienti_8c}
\input{_gestione__clienti_8h}
\input{_gestione__ordini_8c}
\input{_gestione__ordini_8h}
\input{_gestione__prodotti_8c}
\input{_gestione__prodotti_8h}
